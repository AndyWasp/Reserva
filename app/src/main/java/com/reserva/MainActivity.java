...
public class MainActivity extends Activity implements OnSeekBarChangeListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Bundle recibeM = new Bundle();
		recibeM = this.getIntent().getExtras();

		name = recibeM.getString("Usuario");

		correoM = recibeM.getString("correo");
		rating = recibeM.getString("mBar");
